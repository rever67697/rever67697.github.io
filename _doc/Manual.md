...
```yml
# Site settings
title: Rever's Blog             # title of your website
SEOTitle: Rever's Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: Rever     # modify this account to yours
weibo_username: Rever      # the footer woule be auto-updated.
...
For instance, [Hello 2015])(https://rever207.github.io/2015/01/29/hello-2015/) has the front-matter of this:
...
1. a _text style_ header like [this](https://rever207.github.io/2019/09/08/spacemacs-workflow/) with
...
![](http://rever207.github.io/img/blog-sidebar.jpg)
...
![](http://rever207.github.io/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "http://rever207.github.io/js-module-7day/"
---
```
...
It's possible that you want the two things different. For me, my site-title is **“Rever's Blog”** but I want the title shows in search engine is **“黄玄的博客 | Rever's Blog”** which is multi-language.
...
- Brand new [Archive](https://rever207.github.io/archive/) page! It combines previous Archive and Tag page and it's backward-cmpatible.
...
- Fixed [issue#15](https://github.com/Rever207/rever207.github.io/issues/15) about code wrap.
...
<img src="http://rever207.github.io/img/blog-md-navbar.gif" width="320" />
